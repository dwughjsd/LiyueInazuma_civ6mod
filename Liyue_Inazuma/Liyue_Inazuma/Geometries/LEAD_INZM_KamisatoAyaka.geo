...
<AssetObjects..GeometryInstance>
	...
	<m_DataFiles>
		<Element>
			<m_ID text="GR2"/>
			<m_RelativePath text="LEAD_INZM_KamisatoAyaka.fgx"/>
		</Element>
		<Element>
			<m_ID text="WIG"/>
			<m_RelativePath text="LEAD_INZM_KamisatoAyaka.wig"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEAD_INZM_KamisatoAyaka"/>
	<m_Description text="LEAD_INZM_KamisatoAyaka"/>
	<m_Tags>
		<Element text="Leader"/>
	</m_Tags>
</AssetObjects..GeometryInstance>
